...
impl LspClient {
    ...
    pub async fn hover(&mut self, uri: &str, position: LspPosition) -> Result<String> {
        ...
        Ok(format_lsp_result("hover", &result))
    }
    ...
    pub async fn definition(&mut self, uri: &str, position: LspPosition) -> Result<String> {
        ...
        Ok(format_lsp_result("definition", &result))
    }
    ...
    pub async fn references(&mut self, uri: &str, position: LspPosition) -> Result<String> {
        ...
        Ok(format_lsp_result("references", &result))
    }
    ...
    pub async fn diagnostic(&mut self, uri: &str) -> Result<String> {
        ...
        Ok(format_lsp_result("diagnostic", &result))
    }
...
fn parse_lsp_response(response: &serde_json::Value) -> Result<serde_json::Value> {
    ...
    response
        .get("result")
        .cloned()
        .ok_or_else(|| Error::Lsp("LSP response missing 'result'".into()))
}

/// Format an LSP query result into a human-readable string.
fn format_lsp_result(kind: &str, result: &serde_json::Value) -> String {
    match kind {
